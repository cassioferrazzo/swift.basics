...
var reversed = names.sort(comparador)
...
extension String {
    ...
    // Uma função que retorna a string toda em letras minusculas
    ...
    func nonVogals() -> String {
        ...
        for letter in Array(self.lowerCase().getChars()) {
            switch(letter) {
            case "a", "e", "i", "o", "u":
                continue
            default:
